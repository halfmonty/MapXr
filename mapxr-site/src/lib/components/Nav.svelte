...
<div class="navbar bg-base-100 border-b border-base-200 sticky top-0 z-50">
  <div class="navbar-start">
    <a href="{base}/" class="btn btn-ghost text-2xl font-bold">
      <span class="text-primary -mr-1">Map</span>Xr
    </a>
  </div>
  ...
  <div class="navbar-center hidden md:flex">
    <ul class="menu menu-horizontal px-1 gap-1">
      <li>
        <a href="{base}/" class:active={isActive('/')} class="rounded-btn">Home</a>
      </li>
      <li>
        <a href="{base}/docs" class:active={isActive('/docs')} class="rounded-btn">Docs</a>
      </li>
      <li>
        <a href="{base}/devlog" class:active={isActive('/devlog')} class="rounded-btn">Devlog</a>
      </li>
    </ul>
  </div>
  ...
  <div class="navbar-end gap-2">
    ...
    <a
      href="https://github.com/mapxr/mapxr"
      target="_blank"
      rel="noreferrer"
