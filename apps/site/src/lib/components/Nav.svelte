<script lang="ts">
    ...
    let theme = $state(
        browser ? (localStorage.getItem("theme") ?? systemPrefers()) : LIGHT,
    );
...
<div class="navbar bg-base-100 border-b border-base-200 sticky top-0 z-50">
        ...
        <ul class="menu menu-horizontal px-1 gap-1">
            ...
            <li>
                <a
                    ...
                    class="rounded-btn">Docs</a
                >
            </li>
            <li>
                <a
                    href="{base}/devlog"
                    class:active={isActive("/devlog")}
                    class="rounded-btn">Devlog</a
                >
            </li>
        </ul>
    </div>
    ...
    <div class="navbar-end gap-2">
        ...
        <a
            href="https://github.com/halfmonty/mapxr"
            target="_blank"
            rel="noreferrer"
            class="btn btn-ghost btn-circle"
            aria-label="GitHub"
